        ...
        NavigationStack{
            ZStack{
                ...
                CustomTabBarContainerView(selection: $tabSelection) {
                    TeacherListView(displayArray: $modelData.availableTeachers, status: "Available", uiImage: $modelData.uiImage, displayText: availableTeacherDesc)
                               .tabBarItem(tab: .available, selection: $tabSelection)
                    TeacherListView(displayArray: $modelData.requestedTeachers,  status: "Requested", uiImage: $modelData.uiImage, displayText: requestedTeacherDesc)
                               .tabBarItem(tab: .requested, selection: $tabSelection)
                    TeacherListView(displayArray: $modelData.matchedTeachers, status: "Matched", uiImage: $modelData.uiImage, displayText: matchedTeacherDesc)
